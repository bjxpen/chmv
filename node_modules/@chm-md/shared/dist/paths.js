...
export function normalizeChmPath(path) {
...
export function classifyChmPath(path, isDirectory) {
    if (isDirectory) {
        return "directory";
    }
...
export function chmTopicToRoute(topicPath) {
...
export function toDiskPath(projectPath) {
    return projectPath
        .replace(/^\//, "")
        .replace(/[:*?"<>|]/g, "_");
}
...
export function resolveChmHref(baseTopic, href) {
