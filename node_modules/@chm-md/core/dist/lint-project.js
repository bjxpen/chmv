...
function isMarkdownlintWarning(warning) {
...
export async function lintProject(options) {
    ...
    const existingWarnings = existsSync(warningsPath)
        ? JSON.parse(await readFile(warningsPath, "utf8"))
        : [];
    ...
    for (const pagePath of pageFiles) {
        ...
        const processedBody = postProcessMarkdown(markdownBody.replace(/^\n+/, ""), profile, { demoteH1: false });
