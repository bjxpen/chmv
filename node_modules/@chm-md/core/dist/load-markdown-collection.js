...
export async function isMarkdownDocsDir(target) {
    try {
...
export async function loadMarkdownCollection(options) {
...
function directoryToNav(directory) {
    const nodes = [];
...
function resolveDefaultTopic(files, nav) {
...
function findFirstNavLink(nodes) {
...
async function resolveCollectionTitle(sourceDir, fallback) {
...
//# sourceMappingURL=load-markdown-collection.js.map